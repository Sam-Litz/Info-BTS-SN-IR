...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _compteur=R4
	.DEF _compteur_msb=R5
	.DEF _quartet=R6
	.DEF _quartet_msb=R7
	.DEF _tempo=R8
	.DEF _tempo_msb=R9
	.DEF _interruption=R10
	.DEF _interruption_msb=R11
...
; 0000 002C   interruption = 0;
	CLR  R10
	CLR  R11
; 0000 002D   interruption = 1600;
	LDI  R30,LOW(1600)
	LDI  R31,HIGH(1600)
	MOVW R10,R30
; 0000 002E }
...
; 0000 0034 // interruption toutes les 250 us
; 0000 0035    if (tempo == interruption)// 4000 interruptions = 1 seconde
	__CPWRR 10,11,8,9
	BRNE _0x3
; 0000 0036    {
; 0000 0037    PORTC = compteur;// compteur du PORTC
	OUT  0x15,R4
; 0000 0038 
; 0000 0039    quartet = compteur & 0x0F;                //
	MOVW R30,R4
	ANDI R30,LOW(0xF)
	ANDI R31,HIGH(0xF)
	MOVW R6,R30
; 0000 003A    if (quartet == 0x09)                      //
	LDI  R30,LOW(9)
	LDI  R31,HIGH(9)
	CP   R30,R6
	CPC  R31,R7
	BRNE _0x4
; 0000 003B       {                                      //
; 0000 003C        if (compteur == 0x99)                 //
	LDI  R30,LOW(153)
	LDI  R31,HIGH(153)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0x5
; 0000 003D           {                                  // permet de supprimer l'exa
; 0000 003E            compteur = 0x00;                  //
	CLR  R4
	CLR  R5
; 0000 003F           }                                  //
; 0000 0040        else                                  //
	RJMP _0x6
_0x5:
; 0000 0041             compteur = compteur + 0x07;      //
	MOVW R30,R4
	ADIW R30,7
	MOVW R4,R30
; 0000 0042       }
_0x6:
; 0000 0043    else compteur = compteur + 0x01;
	RJMP _0x7
_0x4:
	MOVW R30,R4
	ADIW R30,1
...
; 0000 006D // Clock value: 1000,000 kHz
; 0000 006E // Mode: Normal top=0xFF
; 0000 006F // OC0 output: Disconnected
; 0000 0070 // Timer Period: 0,256 ms
; 0000 0071 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(2)
	OUT  0x33,R30
...
; 0000 008E // Clock value: Timer2 Stopped
...
; 0000 0097 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 0098 
...
; 0000 009E // INT2: Off
; 0000 009F GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 00A0 MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(15)
	OUT  0x35,R30
; 0000 00A1 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 00A2 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 00A3 
; 0000 00A4 // USART initialization
; 0000 00A5 // USART disabled
; 0000 00A6 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(0)
	OUT  0xA,R30
; 0000 00A7 
; 0000 00A8 // Analog Comparator initialization
; 0000 00A9 // Analog Comparator: Off
; 0000 00AA // The Analog Comparator's positive input is
; 0000 00AB // connected to the AIN0 pin
; 0000 00AC // The Analog Comparator's negative input is
; 0000 00AD // connected to the AIN1 pin
