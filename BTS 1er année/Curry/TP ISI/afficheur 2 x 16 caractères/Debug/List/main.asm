...
;//char time[17] = "Bonjour Sam Litz"  ;
;char time[17] = "                ";

	.DSEG
;unsigned char compteur = 0x00, compteur2 = 0x00, compteur3 = 0x00, compteur4 = 0x00;
;unsigned char quartet, quartet2, quartet3, quartet4;
;
;void main(void)
; 0000 0023 {
...
; 0000 006D // INT0: On
; 0000 006E // INT0 Mode: Rising Edge
; 0000 006F // INT1: On
; 0000 0070 // INT1 Mode: Rising Edge
; 0000 0071 // INT2: Off
; 0000 0072 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0073 MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(15)
	OUT  0x35,R30
; 0000 0074 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0075 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0076 
...
; 0000 0093 // RS - PORTB Bit 0
; 0000 0094 // RD - PORTB Bit 1
; 0000 0095 // EN - PORTB Bit 2
; 0000 0096 // D4 - PORTB Bit 4
; 0000 0097 // D5 - PORTB Bit 5
; 0000 0098 // D6 - PORTB Bit 6
; 0000 0099 // D7 - PORTB Bit 7
; 0000 009A // Characters/line: 16
; 0000 009B lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 009C 
; 0000 009D //Initizlisation de l'afficheur LCD
...
; 0000 00A4 //lcd_puts("Bienvenue ");
; 0000 00A5 
; 0000 00A6 //lcd_gotoxy(10,1);
; 0000 00A7 //lcd_puts("a toi.");
; 0000 00A8 
; 0000 00A9 
; 0000 00AA // Globally enable interrupts
; 0000 00AB #asm("sei")
	SEI
; 0000 00AC 
; 0000 00AD while (1)
...
; 0000 00B5 
; 0000 00B6 
; 0000 00B7     quartet = compteur & 0x0F;
	MOV  R30,R5
	ANDI R30,LOW(0xF)
	MOV  R9,R30
; 0000 00B8     quartet2 = compteur2 & 0x0F;
	MOV  R30,R4
	ANDI R30,LOW(0xF)
	MOV  R8,R30
; 0000 00B9 
; 0000 00BA     if(quartet == 0x09)
	LDI  R30,LOW(9)
	CP   R30,R9
	BRNE _0x7
; 0000 00BB         {if(compteur == 0x99)
	LDI  R30,LOW(153)
	CP   R30,R5
	BRNE _0x8
; 0000 00BC             {compteur = 0x00;
	CLR  R5
; 0000 00BD             if(quartet2 == 0x09)
	LDI  R30,LOW(9)
	CP   R30,R8
	BRNE _0x9
; 0000 00BE                 {if(compteur2 == 0x99)
	LDI  R30,LOW(153)
	CP   R30,R4
	BRNE _0xA
; 0000 00BF                     compteur2 = 0x00;
	CLR  R4
; 0000 00C0                 else
	RJMP _0xB
_0xA:
; 0000 00C1                     compteur2 = compteur2 + 0x07;}
	LDI  R30,LOW(7)
	ADD  R4,R30
_0xB:
; 0000 00C2             else
	RJMP _0xC
_0x9:
; 0000 00C3                 compteur2 = compteur2 + 0x01;}
	INC  R4
_0xC:
; 0000 00C4         else
	RJMP _0xD
_0x8:
; 0000 00C5             compteur = compteur + 0x07;}
	LDI  R30,LOW(7)
	ADD  R5,R30
_0xD:
; 0000 00C6     else
	RJMP _0xE
_0x7:
; 0000 00C7         compteur = compteur + 0x01;
	INC  R5
; 0000 00C8 
; 0000 00C9     time[3] = (compteur & 0x0F) + 0x30;
_0xE:
	MOV  R30,R5
	ANDI R30,LOW(0xF)
	SUBI R30,-LOW(48)
	__PUTB1MN _time,3
; 0000 00CA     time[2] = (compteur & 0xF0)/0x10 + 0x30;
	MOV  R30,R5
	RCALL SUBOPT_0x0
	__PUTB1MN _time,2
; 0000 00CB     time[1] = (compteur2 & 0x0F) + 0x30;
	MOV  R30,R4
	ANDI R30,LOW(0xF)
	SUBI R30,-LOW(48)
	__PUTB1MN _time,1
; 0000 00CC     time[0] = (compteur2 & 0xF0)/0x10 + 0x30;
	MOV  R30,R4
	RCALL SUBOPT_0x0
	STS  _time,R30
; 0000 00CD 
