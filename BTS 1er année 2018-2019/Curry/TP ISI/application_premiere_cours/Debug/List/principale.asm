...
; 0000 0072 // INT0: On
; 0000 0073 // INT0 Mode: Low level
; 0000 0074 // INT1: Off
; 0000 0075 // INT2: Off
; 0000 0076 GICR|=(0<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,0x40
	OUT  0x3B,R30
...
; 0000 0078 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0079 GIFR=(0<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(64)
	OUT  0x3A,R30
; 0000 007A 
...
; 0000 0092 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0093 
; 0000 0094 // Globally enable interrupts
; 0000 0095 #asm("sei")
	SEI
; 0000 0096 
; 0000 0097 while (1)
...
; 0000 009A        PORTC = compteur;
	OUT  0x15,R4
; 0000 009B        delay_ms(TEMPS);
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	RCALL _delay_ms
; 0000 009C 
; 0000 009D        quartet = compteur & 0x0F;
	MOVW R30,R4
	ANDI R30,LOW(0xF)
	ANDI R31,HIGH(0xF)
	MOVW R6,R30
...
; 0000 009F        if(i=0)
	...
	SBIW R30,0
	BREQ _0x6
; 0000 00A0             if(quartet ==0x09)
	LDI  R30,LOW(9)
	LDI  R31,HIGH(9)
	CP   R30,R6
	CPC  R31,R7
	BRNE _0x7
; 0000 00A1                 if(quartet == 0x10)
	LDI  R30,LOW(16)
	LDI  R31,HIGH(16)
	CP   R30,R6
	CPC  R31,R7
	BRNE _0x8
; 0000 00A2                     compteur = 0x00;
	CLR  R4
	CLR  R5
; 0000 00A3                 else
	RJMP _0x9
_0x8:
; 0000 00A4                     compteur = compteur + 0x07;
	MOVW R30,R4
	ADIW R30,7
	MOVW R4,R30
; 0000 00A5             else
_0x9:
	RJMP _0xA
_0x7:
; 0000 00A6                 compteur = compteur + 0x01;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 00A7        i++;
