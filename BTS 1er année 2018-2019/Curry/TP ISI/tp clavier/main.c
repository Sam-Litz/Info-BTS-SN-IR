...
unsigned char touche;               // déclaration de la varibale touche
...
delay_ms(10);            // attente de 10 ms pour éviter les rebons
...
delay_ms(100);           // attente de 10 ms pour éviter les rebons
}
