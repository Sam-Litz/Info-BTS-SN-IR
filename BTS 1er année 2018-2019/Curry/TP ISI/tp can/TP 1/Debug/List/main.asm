...
; 0000 0032 unsigned char tension = 0x00;
...
; 0000 008F // ADC Auto Trigger Source: Free Running
; 0000 0090 // Only the 8 most significant bits of
; 0000 0091 // the AD conversion result are used
; 0000 0092 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0093 ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
...
; 0000 00A1             // Acquisition de la tension sur la voie 2 : ADC2
; 0000 00A2       tension = read_adc(0x02);
	LDI  R26,LOW(2)
	RCALL _read_adc
	MOV  R17,R30
; 0000 00A3       // Conversion DCB pour affichage
; 0000 00A4       tension = tension / 5;
	MOV  R26,R17
	LDI  R27,0
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	RCALL __DIVW21
	MOV  R17,R30
; 0000 00A5       PORTC = tension + (tension/10) * 6;
	MOV  R26,R17
	LDI  R27,0
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
