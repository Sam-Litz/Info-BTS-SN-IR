...
_0x3:
	.DB  0x4C,0x61,0x20,0x74,0x65,0x6E,0x73,0x69
	.DB  0x6F,0x6E,0x20,0x65,0x73,0x74,0x20,0x3A
_0x4:
	.DB  0x20,0x2E,0x20,0x56,0x20,0x20,0x20,0x20
...
; 0000 0093 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0094 ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
...
; 0000 00B1       lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B2       lcd_puts(riot2);
	LDI  R26,LOW(_riot2)
	LDI  R27,HIGH(_riot2)
	RCALL _lcd_puts
; 0000 00B3       // Acquisition de la tension sur la voie 2 : ADC2
; 0000 00B4       tension = read_adc(0x02);
	LDI  R26,LOW(2)
	RCALL _read_adc
	MOV  R17,R30
; 0000 00B5       // Conversion DCB pour affichage
; 0000 00B6       tension = tension / 5;
	MOV  R26,R17
	LDI  R27,0
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	...
	MOV  R17,R30
; 0000 00B7 
; 0000 00B8       riot2[2] = ((tension +(tension/10)*6) & 0x0F) + 0x30;
	RCALL SUBOPT_0x0
	LDI  R26,LOW(6)
	MULS R30,R26
	MOVW R30,R0
	...
	SUBI R30,-LOW(48)
	__PUTB1MN _riot2,2
; 0000 00B9       riot2[0] = ((tension +(tension/10)*6) & 0xF0)/0x10 + 0x30;
	MOV  R22,R17
	CLR  R23
	RCALL SUBOPT_0x0
	LDI  R26,LOW(6)
