...
; 0000 0076 // INT2: Off
; 0000 0077 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0078 MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(15)
	OUT  0x35,R30
; 0000 0079 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 007A GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 007B 
...
; 0000 0093 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0094 
; 0000 0095 // Globally enable interrupts
; 0000 0096 #asm("sei")
	SEI
; 0000 0097 
; 0000 0098 // pour le reset
; 0000 0099 PORTA = 0x40;
	LDI  R30,LOW(64)
	OUT  0x1B,R30
; 0000 009A 
; 0000 009B while (1)
