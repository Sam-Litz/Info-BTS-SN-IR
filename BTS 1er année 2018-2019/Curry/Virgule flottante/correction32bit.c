...
unsigned char chaine[35] = "0 00000000 00000000000000000000000";
...
int main()
{
	...
	for(n=9; n>1; n--)	// -- car de droite à gauche (converssion en binaire)
	{
	...
	for(n=11; n<34; n++) // ++ car de gauche à droite
	{
		mantisse = mantisse * 2;
